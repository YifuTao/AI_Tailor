...
change #1 : load_state_dict_from_url use torch.hub.load_s....
change #2 : chagne forward function in ResNet
'''
import torch
...
class ResNet(nn.Module):
    ...
    def forward(self, x,cam):
        ...
        # the batch is num_views x batch_size so get transform it back later
        # x: torch.Size([batch, 3, 400, 400])
